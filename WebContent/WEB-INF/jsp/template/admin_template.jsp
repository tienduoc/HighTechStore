	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="${pageContext.request.contextPath }/admin/index.html"
				...
				class="logo-mini"><i class="fa fa-home"></i></span> <!-- logo for regular state and mobile devices -->
			...
			<section class="sidebar" style="height: auto;">
				...
				<div class="user-panel">
					<div class="pull-left image">
						...
						<img
							src="${pageContext.request.contextPath }/assets/user/images/account/${sessionScope.acc.photo}"
							class="img-circle">
					</div>
					<div class="pull-left info">

						<a href="${pageContext.request.contextPath }/home/myAccount.html"><h5>${pageContext.request.userPrincipal.name}</h5>
							<p>
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a
						href="${pageContext.request.contextPath }/superadmin/role.html">
							<i class="fa fa-users"></i> <span>Role</span> <span
							class="pull-right-container"> <i class=""></i>
						</span>
					</a></li>
					<li><a
						href="${pageContext.request.contextPath }/superadmin/logs.html">
							<i class="fa fa-history"></i> <span>Logs</span> <span
							class="pull-right-container"> <i class=""></i>
						</span>
					</a></li>
